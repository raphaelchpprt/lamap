...
describe('AddInitiativeForm', () => {
  ...
  it('should render all initiative types in the select', () => {
    ...
    expect(options).toContain('Atelier vélo');
    expect(options).toContain('Point de collecte');
    expect(options).toContain('Composteur collectif');
    expect(options).toContain('AMAP');
    expect(options).toContain('Jardin partagé');
    expect(options).toContain('Grainothèque');
    expect(options).toContain('Friperie');
    expect(options).toContain('Donnerie');
    expect(options).toContain('Épicerie sociale');
    expect(options).toContain('Épicerie vrac');
    expect(options).toContain("Bibliothèque d'objets");
    expect(options).toContain('SEL');
    expect(options).toContain('Accorderie');
