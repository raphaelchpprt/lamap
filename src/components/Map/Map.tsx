      ...
      if (features?.properties) {
        ...
        const html = `
          <div style="width: 280px; padding: 20px; box-sizing: border-box;">
            <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 8px; margin-bottom: 12px; overflow: visible;">
              <div class="popup-badge" style="display: inline-flex; align-items: center; gap: 8px; padding: 6px 12px; border-radius: 9999px; font-size: 12px; font-weight: 700; color: white; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1); backdrop-filter: blur(8px); border: 1px solid rgba(255, 255, 255, 0.1); background: ${gradient}; overflow: visible;">
                ...
                <div style="position: relative; display: inline-flex;">
                  <button 
                    ...
                    style="display: inline-flex; align-items: center; justify-content: center; width: 24px; height: 24px; padding: 0; border-radius: 50%; background: rgba(255, 255, 255, 0.2); border: none; cursor: pointer; transition: background 0.2s; color: white; flex-shrink: 0;"
