...
BEGIN
  ...
  SELECT
    ...
    ranked_initiatives.facebook,
    ranked_initiatives.instagram,
    ranked_initiatives.twitter,
    ranked_initiatives.linkedin,
    ranked_initiatives.youtube,
    ranked_initiatives.tiktok,
